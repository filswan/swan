...
def send_deals(config_path, miner_id, metadata_csv_path=None, deal_list=None):
    ...
    if deal_list:
        send_deals_to_miner(deal_config, deal_list=deal_list)
    elif metadata_csv_path:
        send_deals_to_miner(deal_config, csv_file_path=metadata_csv_path)
    else:
